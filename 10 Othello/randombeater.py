...
def total_board_heuristic(board):  # CHANGES
    num = board.count('.')
    if num >= 24:  # In early game, I'm looking for having as few moves available for my opponent as possible
        return board_mobility(board) + board_corners(board) * 20
    elif num < 24:  # In end game, I'm just looking to win the most amount of pieces
